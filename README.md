...
Example of common git commands. Also practice with branching/merging.
...
## Remote Commands
* 'git remote add alias repoUrl' - define 'alias' as shortcut for 'repoUrl' (usally 'origin' for alias)
